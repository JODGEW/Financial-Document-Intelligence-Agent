...
def build_audit_record(
    ...
    audit_id may be pre-generated by the caller so the same id can be attached
    to the LangSmith run metadata before the graph runs (the trace ↔ audit-log
    join key); when omitted, one is generated here.
    """
