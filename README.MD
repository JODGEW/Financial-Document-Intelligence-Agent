...
12. Then Stage-3.5 reliability and authentication work (state machine, retries, durable failure handling, auth) — **the next dependency**, alongside real public-filing evaluation
