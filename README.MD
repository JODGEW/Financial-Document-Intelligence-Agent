...
8. Reachable review routing for comparison results (reusing the mandatory-review policy) — **the next dependency**, together with a comparison-specific risk policy
