...
- [x] Streams staged status events while the answer is generated and validated, then releases the governance-decided answer in one update (drafts are never transmitted before the decision)
